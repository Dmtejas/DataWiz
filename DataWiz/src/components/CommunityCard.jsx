...
const CommunityCard = ({heading, content, button, url}) => {
    ...
    return (
        <div className="bg-transparent rounded-ss-2xl transition-all duration-200 ease-in-out hover:scale-105 shadow-[0_8px_30px_rgba(255,255,255,0.2)] items-start justify-between p-10 flex flex-col space-y-2 lg:space-y-6 text-white">
