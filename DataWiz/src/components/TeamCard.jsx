    ...
    return (
        <div className="grid lg:grid-cols-3 lg:grid-rows-none grid-cols-1 min-h-40 mt-10 lg:mx-10 text-white lg:w-auto w-full">
            {leaders.map((element, index) => {
                return (
                    <div id="core-members" className="flex flex-col items-center justify-between m-7 p-8 gap-y-10 shadow-[0_8px_30px_rgba(255,255,255,0.2)] hover:scale-110 transition-all duration-300 hover:shadow-[0_8px_30px_rgba(255,255,255,0.2)] rounded-3xl">
                        <img
