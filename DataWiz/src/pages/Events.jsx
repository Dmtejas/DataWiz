    ...
    return (
        <div id="teamsPage" className="">
            ...
            <div className="max-w-5xl mx-auto text-center pt-20 p-6">
                ...
                <p className="mt-4 text-white text-2xl italic">Hackathons, workshops, and technical initiatives by DataWiz</p>
            </div>
            <div className="m-4 p-10 shadow-[0_8px_30px_rgba(255,255,255,0.2)] rounded-3xl ">
