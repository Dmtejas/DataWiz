...
const RegisterPage = () => {
    ...
    return (
        <div id="teamsPage">
           ...
           <form onSubmit={handleSubmit} className="shadow-[0_8px_30px_rgba(255,255,255,0.2)] max-w-xs lg:max-w-4xl mx-auto mt-6 p-6 lg:p-10 flex flex-col rounded-2xl lg:rounded-[50px] border-2 lg:border-8 bg-[#160585]">
                ...
                <button type="submit" onClick={handleClick} className="rounded-xl bg-blue-500 text-white text-md lg:text-lg font-bold py-2 lg:py-3 px-10 mx-auto my-5 transition-all duration-300 hover:scale-105 hover:bg-black">Submit details</button>     
            </form> 
        </div>
    )
}
